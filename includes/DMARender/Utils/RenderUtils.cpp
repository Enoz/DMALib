...
bool DMARender::Utils::WorldToScreen(const _D3DMATRIX& view_matrix, const DMARender::Vector3& position, DMARender::Vector2& outScreenPos, const float& renderWidth, const float& renderHeight)
{
...
void DMARender::Utils::drawBoundingBox(const Vector2& top, const Vector2& bottom, float width, const ImU32& color) {
